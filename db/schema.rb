...
ActiveRecord::Schema.define(version: 20180322102738) do
  ...
  create_table "userlogins", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["reset_password_token"], name: "index_userlogins_on_reset_password_token", unique: true
  end
